...
config :study_portal, StudyPortalWeb.Endpoint,
  ...
  render_errors: [
    formats: [json: StudyPortalWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: StudyPortal.PubSub,
  live_view: [signing_salt: "B+QQkLiA"]
...
config :study_portal, StudyPortal.Mailer, adapter: Swoosh.Adapters.Local
