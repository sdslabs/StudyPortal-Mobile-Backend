...
config :study_portal, StudyPortalWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "RxWRFdFWFgI7uoUmRrJ+b5SjYZu/1nGyoGun9LLz3Kpz4mGrAoAdZDcDYFNJ3J9X",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:study_portal, ~w(--sourcemap=inline --watch)]},
...
config :study_portal, dev_routes: true
